...
for n=1:Ne
  ...
  switch popupmenu5value
    ...
    load ('F:\MATLAB\bin\CITRA\training_set\featureout.mat');
    featureout=z;
    %disp(z);
    save ('F:\MATLAB\bin\CITRA\training_set\featureout.mat','featureout');
    test
...
clear all
winopen('F:\MATLAB\bin\CITRA\training_set\output.txt');
